...
% Benoit
\revise{The universal red giant oscillation pattern \citep{mos11} yields $\Delta \nu =  8.31 \pm 0.02 \ \mu\rm{Hz}$ for this system (Section \ref{subsubsec_main_osc}). \newrevise{However, the asymptotic relations for p modes and mixed modes alone are not able to reproduce the position of several peaks in the power spectrum.}
