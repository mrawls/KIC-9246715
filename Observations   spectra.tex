...
Because we incorporate observations from three different spectroscopes and wavelength regimes at two different observatory sites into one dataset, it is critical to apply a consistent wavelength solution that yields the same radial velocity zeropoint for all observations.
