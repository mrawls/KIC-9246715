...
Two lines of constant radii (corresponding to $R_1$ and $R_2$) are shown. As expected, we find very similar masses for both stars. In general, coeval stars on the red giant branch must have masses within $1\%$ of each other, whereas there is slightly more freedom on the horizontal branch due to its longer evolutionary lifetime.
...
%\item Convective overshoot: % ... maybe??
