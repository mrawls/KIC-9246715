...
To approximate the case of KIC 9246715, we consider a detached binary with constant $a$ and constant total stellar masses, and use equations 5 and 6 from \citet{ver95} to calculate the expected change in orbital eccentricity:
