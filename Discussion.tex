...
\end{equation}
These relations should be valid only for oscillation modes of large radial orders $n$, where pressure modes can be mathematically described in the frame of the  in the ``asymptotic development'' (CITE TASSOUL 1980). Even though red-giant do not match these conditions, because radial orders of observed modes are less than 10, the scaling relations look working rather well, some inaccuracy is thus expected.
