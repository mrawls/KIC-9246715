...
\enddata
\label{table1}
\tablenotetext{a}{The triangular limb darkening law (Kipping 2013) re-parameterizes the quadratic limb darkening law, $I(\mu)/I(1) = 1 - u_1(1 - \mu) - u_2(1 - \mu)^2$, with new coefficients $q_1 \equiv (u_1 + u_2)^2$ and $q_2 \equiv 0.5(u_1 + u_2)^{-1}$.}
\end{deluxetable*}
