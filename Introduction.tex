...
While these relations are useful, they remain relatively untested. One notable exception is the red giant in the eclipsing binary KIC 8410637, which shows good agreement between Keplerian and asteroseismic mass and radius according to \citep{fra13}. However, a more recent analysis from Huber 2014 (http://adsabs.harvard.edu/cgi-bin/bib_query?arXiv:1404.7501) indicates that the density is underestimated by ∼7\% (1.8σ, taking
