...
While both the mass and radius scaling relations are useful, they remain relatively untested. One notable exception is the red giant in the eclipsing binary KIC 8410637, which shows good agreement between Keplerian and asteroseismic mass and radius according to \citet{fra13}. However, a more recent analysis from \citet{hub14} indicates that the density is underestimated by $\sim$7\,\% (1.8~$\sigma$, taking the uncertainty in the seismic and dynamical density into account), which results in an overestimate of the radius by $\sim$9\,\% (2.7~$\sigma$) and mass by $\sim$17\,\% (1.9~$\sigma$). In this work, we consider KIC 9246715, an eclipsing binary with two nearly-identical red giant stars, yet only one set of solar-like oscillations.
