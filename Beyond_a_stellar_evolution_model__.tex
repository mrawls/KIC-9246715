...
We estimate the change in eccentricity over a detached binary's lifetime, $\Delta \ln e$, by integrating over the orbit circularization timescale $1/\tau_c \equiv \rm{d} \ln e / \rm{d}t$:
