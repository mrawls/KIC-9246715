...
\begin{equation}
\frac{1}{\tau_c} \equiv \frac{\rm{d} \ln e}{\rm{d}t} = f \left( \frac{L}{M_{\rm{env}}R^2} \right)^{1/3} \frac{M_{\rm{env}}}{M} \frac{M_2}{M} \frac{M+M_2}{M} \left( \frac{R}{a} \right)^8,
\end{equation}
...
\Delta \ln e = \int_0^t \frac{\rm{d}t'}{\tau_c(t')} = -1.7 \times 10^{-5} \ {\left( \frac{M}{M_{\odot}} \right)}^{-11/3} \ q(1+q)^{-5/3} \ I(t) {\left( \frac{P_{\rm{orb}}}{\rm{day}} \right)}^{-16/3},
\end{equation}
